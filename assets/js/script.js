...
const textWa = "Makasi yah udh jadi Adek ku yang paling ngerti aku....🥰💖"
const pesan = `Terima kasih Jeni sudah selalu ada buat saya, walaupun saya agak-agak gituh tapi Jeni selalu ada,
Terima kasih sudah mengantikan sosok Adek ku yang sudah lama ku tak jumpai, karena sedang
mengejar cita-cita nya. but One More i Say Makasi yah....😊😊💖`;
...
hilang1.addEventListener('click', () => {
  ...
  Swal.fire({
    ...
    imageHeight: 120,
    title: 'hei jangan lupa isi nama mu...😁',
    ...
    preConfirm: () => {
      ...
      if (!login) {
        Swal.showValidationMessage(`Masukin Nama mu Dong, CANTIKKK💖 `)
      }
      return { login }
    }
  }).then((result) => {
